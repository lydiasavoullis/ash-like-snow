...
LIST Cas = (cas_left_look), cas_right_look, cas_straight_look
LIST allbooks = Alice_in_Wonderland, Howls_Moving_Castle, t_lion_witch_wardrobe, fantasy_7, nightthunder_89, togue_222, satin_rain_1, myths_legends, togue_394, sentinel_105, fantasy_dragon_heart,black_goat,wildfyre_678,togue_1076,togue_666, hypnos_55,lord_dusk,togue_360,lady_darkness_373,forest_god,t_secret_garden,togue_uniform,x_a_235,the_glass_lab,the_wiz_oz,togue_rain_proof,mr_therm,ring_thorns,the_hobbit,togue_gear,bioworld,heart_lies,matilda,togue_ppe,cybershake,queendom_heretic,alice_looking_glass,togue_acid_rain
