...
~currentSpeaker = you
That sounds very much like a stereotypical fantasy book.
{ChangeSprite("Tali", "tali_exasperated")}
~currentSpeaker = webdev
I know what you're thinking. It's sounds a bit clichéd. 
{ChangeSprite("Tali", "tali_happy")}
Sometimes I just like a good clichéd story you can rely on.
~currentSpeaker = you
You're damn right.
...
~currentSpeaker = webdev
Maybe.
But all the same, I look forward to diving into it.
{ChangeSprite("Tali", "tali_smirk")}
Is that strange?
~currentSpeaker = you
Not at all.
...
{ChangeSprite("Tali", "tali_smirk")}
~currentSpeaker = webdev
I'll give you an in depth review after I've read it.
How about that?
~currentSpeaker = you
...
Spin?
~currentSpeaker = you
Like she gets some kind of redemption arc. Realises that infanticide is bad.
~currentSpeaker = webdev
I don't think so.
~currentSpeaker = you
...
{ChangeSprite("Tali", "tali_smirk")}
~currentSpeaker = webdev
Really? You don't ever wonder what goes on inside the heads of the truly evil?
~currentSpeaker = you
Maybe...
...
Some people try to develop a cure. Others try to develop weapons that will wipe out all the people in the infected areas so they can't spread it. 
~currentSpeaker = you
...
...
~currentSpeaker = comic
She can see in the dark {you}.
{ChangeSprite("Kent", "kent_upset")}
Just read the damn comic.
{ChangeSprite("Kent", "kent_happy")}
The illustrations are quite impressive you won't be disappointed.
~currentSpeaker = you
Alright. Alright.
~music="Rise and shine"
~funds+=90
...
{ChangeSprite("Kent", "kent_happy")}
~currentSpeaker = comic
There's a lot of backlash because the people in his area don't want him to run his shop.
